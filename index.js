...
function generateJwtToken(jwtIssuer, jwtSecret) {
    ...
    const ret = jsonwebtoken_1.default.sign(payload, jwtSecret, { algorithm: 'HS256' });
...
function updateAddon(addonGuid, uploadUuid, jwtToken) {
    return __awaiter(this, void 0, void 0, function* () {
...
function uploadXpi(xpiPath, jwtToken, testerOnly) {
    return __awaiter(this, void 0, void 0, function* () {
...
function run(addonGuid, xpiPath, testerOnly, jwtIssuer, jwtSecret) {
    return __awaiter(this, void 0, void 0, function* () {
        core.info('Start to publish addon.');
        // Create jwt token
        const jwtToken = generateJwtToken(jwtIssuer, jwtSecret);
        // Upload xpi
        const uuid = yield uploadXpi(xpiPath, jwtToken, testerOnly);
        // Update existing addon
        yield updateAddon(addonGuid, uuid, jwtToken);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield run(addonGuid, xpiPath, testerOnly, jwtIssuer, jwtSecret);
        }
        catch (e) {
            handleError(e);
        }
